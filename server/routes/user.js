...
const { changePassword, changeDetails, changeProfilePhoto, fetchNotifications, readNotification } = require("../controllers/userController");
...
router.patch("/notifications/:id", authMiddleware, readNotification);
